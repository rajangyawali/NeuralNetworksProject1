...
# MODEL_PATH = "RBF_model_Fashion_MNIST_Adam_LR0.1_50_clusters{}_epochs.pth".format(MAX_EPOCHS)
# print(MODEL_PATH)
...
model = torch.load('output/RBF_model_Fashion_MNIST_Adam_LR0.1_50_clusters40_epochs.pth')
...
plot_confusion_matrix(confusion_matrix.numpy(), classes=classes, model_name="RBF_Fashion_MNIST_Adam_LR_0.1_50_clusters")
accuracy_precision_recall_f1(confusion_matrix.numpy(), num_classes=num_classes, model_name="RBF_Fashion_MNIST_Adam_LR_0.1_50_clusters")
